...
if __name__=='__main__':
    ...
    usage_def = "Available valid ladder values for NAME:%s    %s"%(os.linesep, ("%s    "%os.linesep).join(ALLOWED_LADDERS))
    parser = ArgumentParser(description=usage_def, epilog="version: %s"%__version__)
